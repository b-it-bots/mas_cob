...
PKG = 'mas_cob_tactile_grasp'

import unittest
import rosunit
import numpy
import mas_cob_tactile_tools.grasp_evaluators
import mas_cob_tactile_tools_common.tactile_filters as tactile_filters
...
class TestGraspEvaluators(unittest.TestCase):
    ...
    def test_true_cylindrical_grasp(self):
        ...
        self.assertEqual(
            mas_cob_tactile_tools.grasp_evaluators.evaluate_cylindrical_grasp(
    ...
    def test_true_spherical_grasp(self):
        ...
        self.assertEqual(
            mas_cob_tactile_tools.grasp_evaluators.evaluate_spherical_grasp(
                contact_matrix_1), result)
        self.assertEqual(
            mas_cob_tactile_tools.grasp_evaluators.evaluate_spherical_grasp(
                contact_matrix_2), result)
    ...
    def test_true_precision_grasp(self):
        ...
        self.assertEqual(
            mas_cob_tactile_tools.grasp_evaluators.evaluate_precision_grasp(
                contact_matrix_1), result)
        self.assertEqual(
            mas_cob_tactile_tools.grasp_evaluators.evaluate_precision_grasp(
                contact_matrix_2), result)
    ...
    def test_true_cylindrical_grasp(self):
        ...
        self.assertEqual(
            mas_cob_tactile_tools.grasp_evaluators.calculate_grasp_status(
