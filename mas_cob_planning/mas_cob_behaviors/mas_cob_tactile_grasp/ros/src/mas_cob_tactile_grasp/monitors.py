...
import mas_cob_tactile_grasp_common.tactile_data_computation as tactile_computation
import mas_cob_tactile_grasp_common.joints_computation as joints_computation
...
class TactileMonitors(object):
    ...
    def __init__(self):
        ...
        self.pub_static_detected_contacts = rospy.Publisher(
            "mas_cob_tactile_grasp_static_contacts_detected",
            std_msgs.msg.UInt16MultiArray)
        self.pub_stop_criteria = rospy.Publisher(
            "mas_cob_tactile_grasp_exceeded_contacts",
            std_msgs.msg.UInt16MultiArray)
        self.pub_contact_regions = rospy.Publisher(
            "mas_cob_tactile_grasp_contact_regions",
            schunk_sdh.msg.TactileSensor)
        self.pub_contact_forces = rospy.Publisher(
            "mas_cob_tactile_grasp_contact_forces",
            schunk_sdh.msg.TactileSensor)
        self.pub_contact_locations = rospy.Publisher(
            "mas_cob_tactile_grasp_contact_locations",
        ...
        rospy.Subscriber("mas_cob_tactile_grasp_contact_thresholds",
                         std_msgs.msg.UInt16MultiArray,
...
class JointMonitors(object):
    ...
    def __init__(self):
        ...
        self.pub_detected_limit_positions = rospy.Publisher(
            "mas_cob_tactile_grasp_exceeded_positions",
            std_msgs.msg.UInt16MultiArray)
        ...
        rospy.Subscriber(
            "mas_cob_tactile_grasp_limit_joint_positions",
